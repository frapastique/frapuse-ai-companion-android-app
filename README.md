...
- The prompt template is adjusted to to [vicuna](https://huggingface.co/TheBloke/Wizard-Vicuna-7B-Uncensored-GPTQ#prompt-template-vicuna), changing that is a tidious task and also has to be done directly from inside the code.
